...
MULTI_UPGRADES = (
    ...
    MultiUpgrade(name='ProtoV3Upgrade_AllVersions_EndsAt_Trunk_HEAD',
                 version_metas=[current_2_1_x, current_2_2_x, current_3_0_x, next_3_x, head_trunk], protocol_version=3, extra_config=None),
    MultiUpgrade(name='ProtoV3Upgrade_AllVersions_RandomPartitioner_EndsAt_Trunk_HEAD',
                 version_metas=[current_2_1_x, current_2_2_x, current_3_0_x, next_3_x, head_trunk], protocol_version=3,
                 extra_config=(
