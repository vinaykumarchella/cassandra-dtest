...
class UpgradeTester(Tester):
    ...
    @known_failure(failure_source='test',
                   jira_url='https://issues.apache.org/jira/browse/CASSANDRA-11668',
                   flaky=True,
                   notes='failing on 3.2 upgrade to 3.3 head')
...
MULTI_UPGRADES = (
    ...
    MultiUpgrade(name='ProtoV3Upgrade_AllVersions_Skips_3_x_EndsAt_Trunk_HEAD',
                 version_metas=[current_2_1_x, current_2_2_x, next_3_0_x, head_trunk], protocol_version=3, extra_config=None),
    MultiUpgrade(name='ProtoV3Upgrade_AllVersions_RandomPartitioner_Skips_3_x_EndsAt_Trunk_HEAD',
                 version_metas=[current_2_1_x, current_2_2_x, next_3_0_x, head_trunk], protocol_version=3,
                 extra_config=(
                     ('partitioner', 'org.apache.cassandra.dht.RandomPartitioner'),
                 )),
)
