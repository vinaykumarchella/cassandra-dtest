...
next_3_0_x = VersionMeta(name='next_3_0_x', variant='next', version='3.0.6-tentative', min_proto_v=3, max_proto_v=4)
...
next_3_x = VersionMeta(name='next_3_x', variant='next', version='3.6-tentative', min_proto_v=3, max_proto_v=4)
