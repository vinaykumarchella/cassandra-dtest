...
next_3_0_x = VersionMeta(name='next_3_0_x', variant='next', version='git:3.0.7-tentative', min_proto_v=3, max_proto_v=4, java_versions=(8,))
...
MANIFEST = {
    indev_2_1_x: [next_3_0_x],
    current_2_1_x: [next_3_0_x],
    next_2_1_x: [next_3_0_x],

    indev_2_2_x: [next_3_0_x],
    current_2_2_x: [next_3_0_x],
    next_2_2_x: [next_3_0_x],
